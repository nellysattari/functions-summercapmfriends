import { ConnectionMessage, IAudioSource, IConnection, Promise } from "../../common/Exports";
...
export declare class ConversationServiceAdapter extends ServiceRecognizerBase {
    ...
    private privConversationConnectionPromise;
    private privConnectionLoop;
    private terminateMessageLoop;
    private privUtteranceId;
    ...
    protected processTypeSpecificMessages(connectionMessage: ConnectionMessage, successCallback?: (e: any) => void, errorCallBack?: (e: string) => void): boolean;
     ...
     */
    protected conversationConnectImpl(isUnAuthorized?: boolean): Promise<IConnection>;
    /**
    ...
    private fetchConversationConnection;
}
